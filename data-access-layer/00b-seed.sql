...
CREATE TABLE recipes (id SERIAL PRIMARY KEY, title VARCHAR(200) NOT NULL,
created TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
updated TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
-- YOUR CODE HERE
CREATE TABLE instructions (id SERIAL PRIMARY KEY,
specification TEXT NOT NULL,
list_order INTEGER NOT NULL,
...
-- YOUR CODE HERE
CREATE TABLE units_of_measure (id SERIAL PRIMARY KEY,
name VARCHAR(20) NOT NULL);
